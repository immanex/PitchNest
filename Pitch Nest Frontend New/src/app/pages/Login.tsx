    ...
    <div className="min-h-screen bg-[#0D1117] text-white flex items-center justify-center px-6">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <p className="text-gray-400 mb-8">Sign in to continue your practice</p>

          {/* Social Login */}
          <div className="space-y-3 mb-6">
            <button className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center gap-3">
          ...
          <form className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/forgot-password" className="text-xs text-[#3B82F6] hover:text-[#7C3AED] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center gap-2">
              <input
                type="checkbox"
                id="remember"
                className="w-4 h-4 rounded border-white/20 bg-white/5 text-[#3B82F6] focus:ring-[#3B82F6]"
              />
          ...
          <p className="text-sm text-gray-400 text-center mt-6">
            ...
            <Link to="/signup" className="text-[#3B82F6] hover:text-[#7C3AED] transition-colors">
              Sign up
            </Link>
          </p>
        </motion.div>
